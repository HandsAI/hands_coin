...
// File: contracts/HANDSCrowdsale.sol
...
/*
    ...
    HANDSContinuousSale public continuousSale;
        ...
        Crowdsale(_startBlock, _endBlock, _initialRate, _wallet)
    {
        ...
        HANDSToken(token).pause();
    }

    function createTokenContract() internal returns(MintableToken) {
        return new HANDSToken();
    }

    function createContinuousSaleContract() internal returns(HANDSContinuousSale) {
        return new HANDSContinuousSale(rate, wallet, token);
    }
