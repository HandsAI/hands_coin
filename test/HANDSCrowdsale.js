...
const HANDSContinuousSale = artifacts.require('./HANDSContinuousSale.sol')
const HANDSToken = artifacts.require('./HANDSToken.sol')

const BigNumber = web3.BigNumber

contract('HANDSCrowdsale', function ([_, wallet, wallet2, buyer, purchaser, buyer2, purchaser2]) {
  ...
  beforeEach(async function () {
    ...
    crowdsale = await HANDSCrowdsale.new(
      startBlock,
      endBlock,
      initialRate,
      endRate,
    ...
    token = HANDSToken.at(await crowdsale.token())
  })
  ...
  it('owner should be able to change wallet', async function () {
    ...
    const continuousSale = HANDSContinuousSale.at(await crowdsale.continuousSale())
  ...
  it('owner should be able to start continuous sale', async function () {
    ...
    const sale = HANDSContinuousSale.at(await crowdsale.continuousSale())
